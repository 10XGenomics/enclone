...
pub fn help5() {
    ...
    */
    ...
    if ( args.len() == 3 && args[1] == "help" && args[2] == "indels" ) || help_all {
        ...
        print( "enclone can recognize and display a single insertion or deletion in a contig \
    ...
    if ( args.len() == 3 && args[1] == "help" && args[2] == "ideas" ) || help_all {
        ...
        ldoc!( "CDRn", "make CDR1 and CDR2 viewable in the same way that CDR3 is now" );
        ldoc!( "distance grouping", "provide an option to group clonotypes by distance" );
        ldoc!( "cloning", "package V..J region into a cloning vector" );
        ldoc!( "phylogeny", "generate a phylogeny for the exact clonotypes within a clonotype" );
    ...
    if ( args.len() == 3 && args[1] == "help" && args[2] == "color" ) || help_all {
        ...
        println!( "Colored amino acids enable the compact display of all the information in a \
                   clonotype.\n" );
        println!( "The coloring is done using special characters, called ANSI escape characters.\n\
        ...
        print( "We know of two methods to get enclone output into another document, along \
            with colors:\n\
            1. Take a screenshot.\n\
    ...
    if ( args.len() == 3 && args[1] == "help" && args[2] == "faq" ) || help_all {
        ...
        end_escape!();
        println!( "We're sorry you're having difficulty!  Please see the answers below, check out\n\
        ...
        print( "\\bold{AMINO=cdr3}\n\
            may help, or even\n\
            \\bold{AMINO=}\n\n" );

        print( "\\boldblue{2. How can I print the entire enclone documentation?}\n\n" );
        println!( "We don't know how in general, but the following works for us from a mac:\n\n\
        ...
        print( "There are several parts to the answer:\n\
        ...
        print( "1. linux/x86-64 (that's most servers)\n\
                2. mac\n\
        ...
        print( "Add the argument \\bold{DONOR_REF_FILE=filename} to your enclone command, \
        ...
        print( "It does not!  It assumes that you have the \\bold{human} reference sequences that \
        ...
        print( "Command line argument values that contain any of these characters ;|* need to \
            be quoted like so\n\
            \\bold{TCR=\"a;b\"}\n\
