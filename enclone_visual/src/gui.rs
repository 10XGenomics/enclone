...
impl Application for EncloneVisual {
    ...
    */
    ...
    fn view(&mut self) -> Element<Message> {
        ...
        let clear_button = Button::new(&mut self.clear_button, Text::new("Clear").font(LIBERATION_SANS))
            .padding(10)
        ...
        let mut command_complex = Row::new().spacing(10);
        {
            ...
            let del_button = Button::new(
                &mut self.del_button,
                Text::new("Del ").font(LIBERATION_SANS).size(COPY_BUTTON_FONT_SIZE),
            )
            ...
            let null_copy_image_button = Button::new(
                ...
                Text::new("          ").font(LIBERATION_SANS).size(COPY_BUTTON_FONT_SIZE),
            )
            .on_press(Message::GraphicsCopyButtonPressed);
            ...
            let state_pos_button = Button::new(
                ...
                Text::new(&state_pos).font(LIBERATION_SANS).size(COPY_BUTTON_FONT_SIZE),
            )
            .on_press(Message::DoNothing);
...
.font(LIBERATION_SANS)
            ...
            row = row.push(
                Button::new(
                    ...
                    Text::new("Copy command").font(LIBERATION_SANS).size(COPY_BUTTON_FONT_SIZE),
                )
        ...
        let left_buttons = Column::new()
            .spacing(8)
            .push(Button::new(&mut self.exit_state, Text::new("Exit").font(LIBERATION_SANS)).on_press(Message::Exit))
            .push(
                Button::new(&mut self.open_state, Text::new("Help").font(LIBERATION_SANS))
                    .on_press(Message::HelpOpen(Ok(()))),
            );
        let console_button = Button::new(&mut self.console_open_button, Text::new("Console").font(LIBERATION_SANS))
            .on_press(Message::ConsoleOpen);
        let snapshot_button = Button::new(
            &mut self.snapshot_button,
            Text::new("Snapshot").font(LIBERATION_SANS).color(self.snapshot_button_color),
        )
        ...
        let tooltip_button = Button::new(
            ...
            Text::new("Tooltip").font(LIBERATION_SANS).color(self.tooltip_toggle_button_color),
        )
