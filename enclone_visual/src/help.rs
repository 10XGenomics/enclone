...
pub fn help(slf: &mut gui_structures::EncloneVisual) -> Element<Message> {
    ...
    let help_close_button =
        Button::new(&mut slf.open_state, Text::new("Dismiss").font(LIBERATION_SANS)).on_press(Message::HelpClose(Ok(())));
    let top_bar = Row::new()
        .push(help_title)
...
.font(LIBERATION_SANS)
        ...
        .push(Space::with_height(Units(20)))
        .push(Text::new("There are input boxes near the top (described next).").font(LIBERATION_SANS).width(max_width))
        .push(Space::with_height(Units(20)))
        .push(
            Text::new(
...
.font(LIBERATION_SANS)
        ...
        .push(Space::with_height(Units(20)))
        .push(Text::new("Group ids are converted into a special enclone argument").font(LIBERATION_SANS).width(max_width))
        .push(Space::with_height(Units(10)))
...
.font(LIBERATION_SANS)
        ...
        .push(Rule::horizontal(10).style(style::RuleStyle2))
        .push(Space::with_height(Units(20)))
        .push(Text::new("History, AKA the time machine").font(LIBERATION_SANS).size(24))
...
.font(LIBERATION_SANS)
        ...
        .push(Rule::horizontal(10).style(style::RuleStyle2))
        .push(Space::with_height(Units(20)))
        .push(Text::new("Limitations, AKA big bugs").font(LIBERATION_SANS).size(24))
        .push(Space::with_height(Units(20)))
        .push(
            Text::new(
        ...
        .push(Space::with_height(Units(20)))
        .push(Text::new("1.  The clonotype tables are black and white.").font(LIBERATION_SANS).width(max_width))
        .push(
