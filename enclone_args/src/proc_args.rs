...
pub fn proc_args(mut ctl: &mut EncloneControl, args: &Vec<String>) -> Result<(), String> {
    ...
    for i in 0..args.len() {
        ...
        let test3plus = "1279065,1279073,1287146,1287152:\
            1279066,1279074,1287156,1287148:1279067,1279075:1279068,1279076";
        let test4plus = "1279069,1279077,1287171,1287160,1287161,1287169:\
