...
fn main() {
    ...
    counts.push((364703_f64 * 0.304).round() as usize);
    counts.push((293532_f64 * 0.696).round() as usize);
    counts.push((352749_f64 * 0.671).round() as usize);
    counts.push((397955_f64 * 0.627).round() as usize);
